...
{
    public class TabCustomerLogic : CommonLogic<TabCustomer, int>,ITabCustomerLogic
    {
        ...
        /// <returns></returns>
        public int Create(TabCustomer entity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(TabCustomer entity)
        {
        ...
        /// <param name="entityId"></param>
        /// <returns></returns>
        public TabCustomer FindByID(int entityId)
        {
        ...
        /// 检索对象
        /// </sammury>
        public IList<TabCustomer> FindAll()
        {
        ...
        /// 检索对象
        /// </sammury>
        public IList<TabCustomer> FindAll(Hashtable table)
        {
