...
{
    public class TabImageLogic : CommonLogic<TabImage, int>,ITabImageLogic
    {
        ...
        /// <returns></returns>
        public int Create(TabImage entity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(TabImage entity)
        {
        ...
        /// <param name="entityId"></param>
        /// <returns></returns>
        public TabImage FindByID(int entityId)
        {
        ...
        /// 检索对象
        /// </sammury>
        public IList<TabImage> FindAll(Hashtable table)
        {
