...
create table Tab_ProjectInfo (
   ...
   P_DesignChange       smallint             null,
   P_DataIn             smallint             null,
...
execute sp_addextendedproperty 'MS_Description', 
   '子项目审计金额',
   'user', @CurrentUser, 'table', 'Tab_ProjectInfo', 'column', 'SP_Auditors'
go
...
execute sp_addextendedproperty 'MS_Description', 
   '子项目成本占收比',
   'user', @CurrentUser, 'table', 'Tab_ProjectInfo', 'column', 'SP_Ratio'
go
