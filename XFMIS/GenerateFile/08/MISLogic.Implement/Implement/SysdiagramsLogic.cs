...
{
    public class SysdiagramsLogic : CommonLogic<Sysdiagrams, int>,ISysdiagramsLogic
    {
        ...
        /// <returns></returns>
        public int Create(Sysdiagrams entity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(Sysdiagrams entity)
        {
        ...
        /// <param name="entityId"></param>
        /// <returns></returns>
        public Sysdiagrams FindByID(int entityId)
        {
        ...
        /// 检索对象
        /// </sammury>
        public IList<Sysdiagrams> FindAll()
        {
        ...
        /// 检索对象
        /// </sammury>
        public IList<Sysdiagrams> FindAll(Hashtable table)
        {
