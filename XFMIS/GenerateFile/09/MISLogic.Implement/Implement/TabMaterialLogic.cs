...
{
    public class TabMaterialLogic : CommonLogic<TabMaterial, int>,ITabMaterialLogic
    {
        ...
        /// <returns></returns>
        public int Create(TabMaterial entity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(TabMaterial entity)
        {
        ...
        /// <param name="entityId"></param>
        /// <returns></returns>
        public TabMaterial FindByID(int entityId)
        {
        ...
        /// 检索对象
        /// </sammury>
        public IList<TabMaterial> FindAll()
        {
        ...
        /// 检索对象
        /// </sammury>
        public IList<TabMaterial> FindAll(Hashtable table)
        {
