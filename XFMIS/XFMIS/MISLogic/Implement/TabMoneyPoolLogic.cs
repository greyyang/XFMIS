...
{
    public class TabMoneyPoolLogic : CommonLogic<TabMoneyPool, int>,ITabMoneyPoolLogic
    {
        ...
        /// <returns></returns>
        public int Create(TabMoneyPool entity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(TabMoneyPool entity)
        {
        ...
        /// <param name="entityId"></param>
        /// <returns></returns>
        public TabMoneyPool FindByID(int entityId)
        {
        ...
        /// 检索对象
        /// </sammury>
        public IList<TabMoneyPool> FindAll()
        {
        ...
        /// 检索对象
        /// </sammury>
        public IList<TabMoneyPool> FindAll(Hashtable table)
        {
