...
namespace MISEntity.Entity
{
	...
	public class TabProjectInfo
	{
		...
		private decimal? m_PAllocation;
		
		public decimal? PAllocation
		{
			get { return m_PAllocation; }
			set { m_PAllocation = value; }
		}
		...
		private string m_PDesignChange;
