...
{
    public class TabPaymentLogic : CommonLogic<TabPayment, int>,ITabPaymentLogic
    {
        ...
        /// <returns></returns>
        public int Create(TabPayment entity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(TabPayment entity)
        {
        ...
        /// <param name="entityId"></param>
        /// <returns></returns>
        public TabPayment FindByID(int entityId)
        {
        ...
        /// 检索对象
        /// </sammury>
        public IList<TabPayment> FindAll()
        {
        ...
        /// 检索对象
        /// </sammury>
        public IList<TabPayment> FindAll(Hashtable table)
        {
