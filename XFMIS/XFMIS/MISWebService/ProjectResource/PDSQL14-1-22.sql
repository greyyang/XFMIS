...
/* Created on:     1/22/2014 4:59:32 PM                         */
/*==============================================================*/
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('Tab_CostAndReimburse') and o.name = 'FK_TAB_COST_REFERENCE_TAB_PROJ')
alter table Tab_CostAndReimburse
   drop constraint FK_TAB_COST_REFERENCE_TAB_PROJ
go
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('Tab_MaterialFlow') and o.name = 'FK_TAB_MATE_R_10_TAB_MATE')
alter table Tab_MaterialFlow
   drop constraint FK_TAB_MATE_R_10_TAB_MATE
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('Tab_Payment') and o.name = 'FK_TAB_PAYM_REFERENCE_TAB_PROJ')
alter table Tab_Payment
   drop constraint FK_TAB_PAYM_REFERENCE_TAB_PROJ
go
...
if exists (select 1
            from  sysobjects
           where  id = object_id('Tab_Image')
            and   type = 'U')
   drop table Tab_Image
go
...
if exists (select 1
            from  sysobjects
           where  id = object_id('Tab_MoneyPool')
            and   type = 'U')
   drop table Tab_MoneyPool
go
...
execute sp_addextendedproperty 'MS_Description', 
   '外键主工程ID',
   'user', @CurrentUser, 'table', 'Tab_CostAndReimburse', 'column', 'CR_PID'
go
...
execute sp_addextendedproperty 'MS_Description', 
   '申请人',
   'user', @CurrentUser, 'table', 'Tab_CostAndReimburse', 'column', 'CR_Person'
go
...
execute sp_addextendedproperty 'MS_Description', 
   '经手人',
   'user', @CurrentUser, 'table', 'Tab_CostAndReimburse', 'column', 'CR_Handler'
go
...
select @CurrentUser = user_name()
execute sp_addextendedproperty 'MS_Description', 
   '种类标识(0-成本,1-报账,2-管理费)',
   'user', @CurrentUser, 'table', 'Tab_CostAndReimburse', 'column', 'CR_Flag'
go
...
create table Tab_Image (
   ...
   TI_NO                int                  null,
   TI_Image             image                null,
   constraint PK_TAB_IMAGE primary key (TI_ID)
)
go
...
execute sp_addextendedproperty 'MS_Description', 
   '合同图片表',
   'user', @CurrentUser, 'table', 'Tab_Image'
go
...
execute sp_addextendedproperty 'MS_Description', 
   '合同图片ID',
   'user', @CurrentUser, 'table', 'Tab_Image', 'column', 'TI_ID'
go
...
execute sp_addextendedproperty 'MS_Description', 
   '关联主项目',
   'user', @CurrentUser, 'table', 'Tab_Image', 'column', 'TI_ProjectID'
go
...
execute sp_addextendedproperty 'MS_Description', 
   '关联子项目',
   'user', @CurrentUser, 'table', 'Tab_Image', 'column', 'TI_SubProjectID'
go
...
execute sp_addextendedproperty 'MS_Description', 
   '所对应项目中的顺序编号',
   'user', @CurrentUser, 'table', 'Tab_Image', 'column', 'TI_NO'
go
...
execute sp_addextendedproperty 'MS_Description', 
   '图片文件',
   'user', @CurrentUser, 'table', 'Tab_Image', 'column', 'TI_Image'
go
...
execute sp_addextendedproperty 'MS_Description', 
   '借还款标识(0-借款,1-还款)',
   'user', @CurrentUser, 'table', 'Tab_LoanRepay', 'column', 'LR_Flag'
go
...
/* Table: Tab_MoneyPool                                         */
/*==============================================================*/
create table Tab_MoneyPool (
   MP_ID                int                  identity,
   MP_Money             decimal(15,2)        null,
   MP_Handler           varchar(100)         null,
   MP_Date              datetime             null,
   MP_Memo              varchar(500)         null,
   MP_Flag              int                  null,
   constraint PK_TAB_MONEYPOOL primary key (MP_ID)
)
go
...
execute sp_addextendedproperty 'MS_Description', 
   '资金池表单',
   'user', @CurrentUser, 'table', 'Tab_MoneyPool'
go
...
execute sp_addextendedproperty 'MS_Description', 
   '资金池主键ID',
   'user', @CurrentUser, 'table', 'Tab_MoneyPool', 'column', 'MP_ID'
go
...
execute sp_addextendedproperty 'MS_Description', 
   '资金',
   'user', @CurrentUser, 'table', 'Tab_MoneyPool', 'column', 'MP_Money'
go
...
execute sp_addextendedproperty 'MS_Description', 
   '经手人',
   'user', @CurrentUser, 'table', 'Tab_MoneyPool', 'column', 'MP_Handler'
go
...
execute sp_addextendedproperty 'MS_Description', 
   '日期',
   'user', @CurrentUser, 'table', 'Tab_MoneyPool', 'column', 'MP_Date'
go
...
execute sp_addextendedproperty 'MS_Description', 
   '备注',
   'user', @CurrentUser, 'table', 'Tab_MoneyPool', 'column', 'MP_Memo'
go
...
execute sp_addextendedproperty 'MS_Description', 
   '判断出入的标识（1为入，0为出）',
   'user', @CurrentUser, 'table', 'Tab_MoneyPool', 'column', 'MP_Flag'
go
...
execute sp_addextendedproperty 'MS_Description', 
   '外键关联主工程ID',
   'user', @CurrentUser, 'table', 'Tab_Payment', 'column', 'PY_PID'
go
...
execute sp_addextendedproperty 'MS_Description', 
   '开票回款标识(0-开票,1-回款)',
   'user', @CurrentUser, 'table', 'Tab_Payment', 'column', 'PY_Flag'
go
...
create table Tab_ProjectInfo (
   ...
   P_DesignChange       varchar(50)          null,
   P_DataIn             varchar(50)          null,
...
execute sp_addextendedproperty 'MS_Description', 
   '主项目分包计划',
   'user', @CurrentUser, 'table', 'Tab_ProjectInfo', 'column', 'P_Allocation'
go
...
execute sp_addextendedproperty 'MS_Description', 
   '主子工程区分，主工程为1,子工程为0',
   'user', @CurrentUser, 'table', 'Tab_StateRecord', 'column', 'SR_State'
go
...
alter table Tab_CostAndReimburse
   add constraint FK_TAB_COST_REFERENCE_TAB_PROJ foreign key (CR_PID)
...
alter table Tab_MaterialFlow
   add constraint FK_TAB_MATE_R_10_TAB_MATE foreign key (MF_MaterialID)
      references Tab_Material (M_ID)
         on update cascade on delete cascade
go

alter table Tab_Payment
   add constraint FK_TAB_PAYM_REFERENCE_TAB_PROJ foreign key (PY_PID)
      references Tab_ProjectInfo (P_ID)
         on update cascade on delete cascade
go
