...
{
    public class TabUsersLogic : CommonLogic<TabUsers, int>,ITabUsersLogic
    {
        ...
        /// <returns></returns>
        public int Create(TabUsers entity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(TabUsers entity)
        {
        ...
        /// <param name="entityId"></param>
        /// <returns></returns>
        public TabUsers FindByID(int entityId)
        {
        ...
        /// 检索对象
        /// </sammury>
        public IList<TabUsers> FindAll(Hashtable table)
        {
