...
{
    public class MyUserLogic : CommonLogic<MyUser, int>,IMyUserLogic
    {
        ...
        /// <returns></returns>
        public int Create(MyUser entity)
        {
        ...
        /// <param name="entityId"></param>
        /// <returns></returns>
        public MyUser FindByID(int entityId)
        {
        ...
        /// 检索对象
        /// </sammury>
        public IList<MyUser> FindAll(Hashtable table)
        {
