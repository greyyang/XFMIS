...
{
    public class TabLoanRepayLogic : CommonLogic<TabLoanRepay, int>,ITabLoanRepayLogic
    {
        ...
        /// <returns></returns>
        public int Create(TabLoanRepay entity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(TabLoanRepay entity)
        {
        ...
        /// <param name="entityId"></param>
        /// <returns></returns>
        public TabLoanRepay FindByID(int entityId)
        {
        ...
        /// 检索对象
        /// </sammury>
        public IList<TabLoanRepay> FindAll()
        {
        ...
        /// 检索对象
        /// </sammury>
        public IList<TabLoanRepay> FindAll(Hashtable table)
        {
