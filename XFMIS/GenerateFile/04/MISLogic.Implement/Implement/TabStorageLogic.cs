...
{
    public class TabStorageLogic : CommonLogic<TabStorage, int>,ITabStorageLogic
    {
        ...
        /// <returns></returns>
        public int Create(TabStorage entity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update(TabStorage entity)
        {
        ...
        /// <param name="entityId"></param>
        /// <returns></returns>
        public TabStorage FindByID(int entityId)
        {
        ...
        /// 检索对象
        /// </sammury>
        public IList<TabStorage> FindAll()
        {
        ...
        /// 检索对象
        /// </sammury>
        public IList<TabStorage> FindAll(Hashtable table)
        {
